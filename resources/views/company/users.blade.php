    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <div class="btn-group">
                    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#add"><i class="fa fa-plus"></i> Add new user</button>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-striped display" id="table-user">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @foreach($users as $key => $user)
                                    @php
                                        $_etype = "-";
                                        if(isset($emp_type[$user->emp_id])){
                                            $_etype = $etype[$emp_type[$user->emp_id]] ?? "-";
                                        }
                                    @endphp
                                    <tr>
                                        ...
                                        <td nowrap="nowrap" align="center">
                                            <label for="" class="label label-inline label-primary">{{$user->email}}</label>
                                        </td>
                                        <td align="center">
                                            {{(isset($emp[$user->emp_id])) ? $emp[$user->emp_id] : ""}}
                                        </td>
                                        <td nowrap="nowrap" align="center">
                                            {{ $user->uacrole->name ?? "-" }}
                                        </td>
                                        {{-- <td align="center">
                                            <a href="{{ route('pref.cr.user', $user->id) }}" class="btn btn-icon btn-warning btn-sm">
                                                <i class="fa fa-key"></i>
                                            </a>
                                        </td> --}}
                                        <td nowrap="nowrap" align="center">
                                            ...
                                            <button type="button" data-bs-target="#edit{{$user->id}}" data-bs-toggle="modal" class="btn btn-sm btn-primary btn-icon btn-icon-md" title="Edit"><i class="la la-edit"></i></button>
                                            @if($user->id > 1)
