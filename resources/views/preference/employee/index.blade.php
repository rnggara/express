        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addParameter"><i class="fa fa-plus"></i>Add New Parameter</button>
                </div>
                    ...
                    <table class="table table-bordered table-hover display font-size-sm data-table" style="margin-top : 13px !important; width: 100%; ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="{{ route('employeevar.edit') }}" class="btn btn-primary btn-xs btn-icon fa fa-edit" data-bs-toggle="modal" data-bs-target="#editParameter"></a>
