		...
		<div class="row mb-5">
			<div class="col-6">
				<div class="btn-group">
					...
					<button type="button" class="btn btn-sm btn-primary" id="btn-report">Report</button>
				</div>
			</div>
		</div>
		<div class="row">
	        	...
	        	<div class="modal-body">
	            	...
	            	<div class="form-group row">
	            		...
	            		<div class="col-9">
	            			...
	            			<span class="text-danger">* Maximum File Upload = 200 MB</span>
	            		</div>
	            	</div>
	            </div>
