...
@section('view_content')
    <div class="d-flex flex-column">
        <div class="card">
            <div class="card-header border-bottom-0 px-0">
                <div class="d-flex flex-column">
                    <h3 class="card-title">Line of Business</h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 py-2 menu-state-bg-light-primary fw-semibold w-auto min-w-200 mw-300px" data-kt-menu="true">
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="javascript:;" @if(!empty($item->record_id)) data-bs-toggle="modal" data-bs-target="#modal_edit_{{ $item->id }}" @endif class="menu-link px-3 {{ empty($item->record_id) ? "disabled text-muted" : "" }}">
                                                    Edit Data
                                                </a>
                                            </div>
                                            <!--end::Menu item-->
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <div class="d-flex flex-column align-items-center">
                                                                ...
                                                                <span class="text-center">make sure Line of Business not used to employee</span>
                                        ...
                                        <form action="{{ route("crm.pref.company.company_list.update_detail", ['type' => $type, "id" => base64_encode($company->id)]) }}" method="post">
                                            @component('layouts._crm_modal', [
                                                ...
                                                @slot('modalTitle')
                                                    <div class="d-flex flex-column">
                                                        <span class="fs-1 fw-bold">Edit Line of Business</span>
                                                        <span class="fs-base fw-normal mt-2">Fill the form to set Line of Business</span>
                                                    </div>
                                                @endslot
                                                @slot('modalContent')
                                                    <div class="fv-row">
                                                    ...
                                                    <div class="fv-row">
                                                        ...
                                                        <input type="text" name="description" value="{{ $item->name }}" placeholder="Example: Manufacture, Contractor, and others" class="form-control">
                                                        @error('description')
                                                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                                                {{ $message }}
                                                            </div>
    ...
    <form action="{{ route("crm.pref.company.company_list.update_detail", ['type' => $type, "id" => base64_encode($company->id)]) }}" method="post">
        @component('layouts._crm_modal', [
            ...
            @slot('modalTitle')
                <div class="d-flex flex-column">
                    <span class="fs-1 fw-bold">Add Line of Business</span>
                    <span class="fs-base fw-normal mt-2">Fill the form to set Line of Business</span>
                </div>
            @endslot
            @slot('modalContent')
                ...
                <div class="fv-row">
                    <label class="col-form-label required">Description</label>
                    <input type="text" name="description" value="{{ old("description") }}" placeholder="Example: Manufacture, Contractor, and others" class="form-control">
                    @error('description')
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            {{ $message }}
                        </div>
