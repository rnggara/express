...
@section('view_content')
            ...
            <div class="card-header border-bottom-0 px-0">
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <span class="fw-semibold">Job Level</span>
                    </div>
                </div>
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route("crm.pref.company.job_level.post", base64_encode($company->id)) }}" method="post">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <div class="d-flex flex-column align-items-center">
                                                                ...
                                                                <span class="text-center">make sure Job Level not used to employee</span>
                                            ...
                                            @component('layouts._crm_modal', [
                                                ...
                                                @slot('modalContent')
                                                    ...
                                                    <div class="fv-row">
                                                        ...
                                                        <input type="text" name="job_level" value="{{ $item->name }}" placeholder="Example: Director, Vice President, Manager, and others" class="form-control">
                                                        @error('job_level')
                                                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                                                {{ $message }}
                                                            </div>
    ...
    <form action="{{ route("crm.pref.company.job_level.post", base64_encode($company->id)) }}" method="post">
        @component('layouts._crm_modal', [
            ...
            @slot('modalTitle')
                <div class="d-flex flex-column">
                    <span class="fs-1 fw-bold">Add Job Level</span>
            ...
            @slot('modalContent')
                ...
                <div class="fv-row">
                    <label class="col-form-label required">Job Level</label>
                    <input type="text" name="job_level" value="{{ old("job_level") }}" placeholder="Example: Director, Vice President, Manager, and others" class="form-control">
                    @error('job_level')
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            {{ $message }}
                        </div>
