<div class="d-flex flex-column align-items-center" data-form-clone>
    <div class="card bg-transparent mb-5 shadow-none w-100" data-clone>
        <div class="card-body rounded bg-white p-5">
            ...
            <div class="row" data-form-add>
                <div class="fv-row col-6">
                    ...
                    <select name="degree[]" class="form-select" data-label data-control="select2" data-hide-search="true" data-placeholder="Select Degree">
                        <option value=""></option>
                ...
                <div class="fv-row col-6">
                    ...
                    <input type="text" name="field_of_study[]" data-label value="" placeholder="Input Major" class="form-control">
                </div>
                <div class="fv-row col-6">
                    <label class="col-form-label">GPA</label>
                    <input type="number" min="0" max="4" step=".01" name="grade[]" value="" placeholder="Input GPA" class="form-control">
                </div>
                <div class="fv-row col-6">
                    <label class="col-form-label">Institution Name</label>
                    <input type="text" name="school_name[]" placeholder="Input Institution Name" value="" class="form-control">
                </div>
                <div class="fv-row col-6">
                    <label class="col-form-label">Year Graduate</label>
                    <input type="number" name="year_graduate[]" min="1000"  value="" placeholder="Input Year Graduate" class="form-control">
                </div>
                <div class="fv-row col-6">
