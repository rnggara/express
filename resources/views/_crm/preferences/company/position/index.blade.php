...
@section('view_content')
            ...
            <div class="card-body rounded bg-secondary-crm">
                <div class="d-flex flex-column">
                    <div class="d-flex align-items-center justify-content-between mb-5">
                        ...
                        <a href="{{ route('crm.pref.company.position.structure', base64_encode($company->id)) }}" class="btn btn-primary">
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route("crm.pref.company.position.post", base64_encode($company->id)) }}" method="post">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <div class="d-flex flex-column align-items-center">
                                                                ...
                                                                <span class="text-center">make sure Position not used to employee</span>
                                        ...
                                        <form action="{{ route("crm.pref.company.position.post", base64_encode($company->id)) }}" method="post">
                                            @component('layouts._crm_modal', [
                                                ...
                                                @slot('modalTitle')
                                                    <div class="d-flex flex-column">
                                                        <span class="fs-1 fw-bold">Edit Position</span>
                                                ...
                                                @slot('modalContent')
                                                    ...
                                                    <div class="fv-row">
                                                        ...
                                                        <input type="text" name="position" value="{{ $item->name }}" placeholder="Example: Marketing, Sales, Developer, and others" class="form-control">
                                                        @error('position')
                                                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="fv-row">
                                                        <label class="col-form-label">Parent Position</label>
                                                        <select name="parent_id" data-dropdown-parent="#modal_edit_{{ $item->id }}" class="form-select" data-control="select2" data-placeholder="Select Position">
                                                            <option value=""></option>
                                                    ...
                                                    <div class="fv-row">
                                                        ...
                                                        <input type="number" name="user_count" value="{{ $item->user_count }}" placeholder="1" class="form-control">
                                                    </div>
                                                @endslot
                                                @slot('modalFooter')
                                                    @csrf
    ...
    <form action="{{ route("crm.pref.company.position.post", base64_encode($company->id)) }}" method="post">
        @component('layouts._crm_modal', [
            ...
            @slot('modalTitle')
                <div class="d-flex flex-column">
                    <span class="fs-1 fw-bold">Add Position</span>
                    <span class="fs-base fw-normal mt-2">&nbsp;&nbsp; </span>
                </div>
            @endslot
            @slot('modalContent')
                ...
                <div class="fv-row">
                    <label class="col-form-label required">Position</label>
                    <input type="text" name="position" value="{{ old("position") }}" placeholder="Example: Marketing, Sales, Developer, and others" class="form-control">
                    @error('position')
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="fv-row">
                    <label class="col-form-label">Parent Position</label>
                    <select name="parent_id" data-dropdown-parent="#modal_add" class="form-select" data-control="select2" data-placeholder="Select Position">
                        <option value=""></option>
                        @foreach ($data as $item)
                ...
                <div class="fv-row">
                    <label class="col-form-label">Man Power</label>
                    <input type="number" name="user_count" value="1" placeholder="1" class="form-control">
                </div>
            @endslot
            @slot('modalFooter')
                @csrf
