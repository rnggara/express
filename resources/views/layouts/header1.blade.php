                                            ...
                                            <ul class="menu-content">
                                                ...
                                                <li class="menu-item">
                                                    ...
                                                    <ul class="menu-inner">
                                                        ...
                                                        @actionStart('to', 'access')
                                                        <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                            <a href="{{route('g.ti.index')}}" class="menu-link">
                                                                    <i class="menu-bullet menu-bullet-line">
                                                                        <span></span>
                                                                    </i>
                                                                <span class="menu-text">Travel Instruction</span>
                                                            </a>
                                                        </li>
                                                        @actionEnd
                                                ...
                                                <li class="menu-item">
                                                    ...
                                                    <ul class="menu-inner">
                                                        ...
                                                        <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                            <a href="{{route('ud.index', 'user-driver')}}" class="menu-link">
                                                                    <i class="menu-bullet menu-bullet-line">
                                                                        <span></span>
                                                                    </i>
                                                                <span class="menu-text">User & Driver List </span>
                                                            </a>
                                                        </li>
                                                        <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                            <a href="{{route('ud.index', 'GA-staff')}}" class="menu-link">
                                                                    <i class="menu-bullet menu-bullet-line">
                                                                        <span></span>
                                                                    </i>
                                                                <span class="menu-text">GA Staff List </span>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </li>
                                ...
                                <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
                                    ...
                                    <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                        <ul class="menu-subnav">
                                            ...
                                            <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                <a href="{{route('marketing.tender.index')}}" class="menu-link">
                                                    <span class="svg-icon menu-icon">
                                                            <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Add-user.svg-->
                                            ...
                                            <ul class="menu-content">
                                                <li class="menu-item">
                                                    ...
                                                    <ul class="menu-inner">
                                                        ...
                                                        @actionEnd
                                                        @actionStart('employee', 'approvediv1')
                                                        <li class="menu-item"  aria-haspopup="true">
                                                            <a href="{{route('employee.pb.index')}}" class="menu-link">
                                                                    <i class="menu-bullet menu-bullet-line">
                                                                <span></span>
                                                            </i>
                                                                <span class="menu-text">Employee Performance Bonus</span>
                                                            </a>
                                                        </li>
                                                        @actionEnd
                                                        @actionStart('employee', 'access')
                                                        <li class="menu-item"  aria-haspopup="true">
                                                            <a href="{{route('emp.mt.index')}}" class="menu-link">
                                                                    <i class="menu-bullet menu-bullet-line">
                                                                <span></span>
                                                            </i>
                                                                <span class="menu-text">Mobile Attendance</span>
                                                            </a>
                                                        </li>
                                                        @actionEnd
                                                        @actionStart('employee', 'access')
                                                        ...
                                                        @actionStart('payroll', 'access')
                                                        <li class="menu-item"  aria-haspopup="true">
                                                            <a href="{{URL::route('payroll_new.index')}}" class="menu-link">
                                                                    <i class="menu-bullet menu-bullet-line">
                                                                <span></span>
                                                            </i>
                                                                <span class="menu-text">Payroll 2</span>
                                                ...
                                                <li class="menu-item">
                                                    ...
                                                    <ul class="menu-inner">
                                                        ...
                                                        @actionStart('employee', 'access')
                                                        <li class="menu-item"  aria-haspopup="true">
                                                            <a href="{{URL::route('hrd.test.index')}}" class="menu-link">
                                                                    <i class="menu-bullet menu-bullet-line">
                                                                <span></span>
                                                            </i>
                                                                <span class="menu-text">Employee Test</span>
                                            ...
                                            <ul class="menu-content">
                                                ...
                                                <li class="menu-item">
                                                    ...
                                                    <ul class="menu-inner">
                                                        ...
                                                        <li class="menu-item" aria-hashpopup="true">
                                                            <a href="{{route('ha.powo.setting')}}" class="menu-link">
                                                                <i class="menu-bullet menu-bullet-line">
                                                                    <span></span>
                                                                </i>
                                                ...
                                                <li class="menu-item">
                                                    ...
                                                    <ul class="menu-inner">
                                                        ...
                                                        <li class="menu-item" aria-haspopup="true">
                                                            <a href="{{URL::route('finance.thr.index')}}" class="menu-link">
                                                                <i class="menu-bullet menu-bullet-line">
                                                                    <span></span>
                                                                </i>
                                                ...
                                                <li class="menu-item">
                                                    ...
                                                    <ul class="menu-inner">
                                                        ...
                                                        <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                            <a href="{{route('ud.finance', 'weekly-allowance')}}" class="menu-link">
                                                                    <i class="menu-bullet menu-bullet-line">
                                                                        <span></span>
                                                                    </i>
                                                                <span class="menu-text">Weekly Allowance</span>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            ...
                                            <ul class="menu-content">
                                                <li class="menu-item">
                                                    ...
                                                    <ul class="menu-inner">
                                                        ...
                                                        @actionStart("inv_out", 'access')
                                                        <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                            <a href="{{route('report.pi.index')}}" class="menu-link">
                                                                <i class="menu-bullet menu-bullet-line">
                                                                    <span></span>
                                                                </i>
                                                                <span class="menu-text">Report Proforma Invoice</span>
                                                            </a>
                                                        </li>
                                                        @actionEnd
                                                        @actionStart("loan", 'access')
                                                        <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                            <a href="{{route('report.loan')}}" class="menu-link">
                                                                <i class="menu-bullet menu-bullet-line">
                                                                    <span></span>
                                                                </i>
                                                                <span class="menu-text">Report Loan</span>
                                                            </a>
                                                        </li>
                                                        @actionEnd
                                                        @actionStart("leasing", 'access')
                                                        <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                            <a href="{{route('report.leasing')}}" class="menu-link">
                                                                <i class="menu-bullet menu-bullet-line">
                                                                    <span></span>
                                                                </i>
                                                                <span class="menu-text">Report Leasing</span>
                                                            </a>
                                                        </li>
                                                        @actionEnd
                                                    </ul>
                                ...
                                <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
                                    ...
                                    <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                        <ul class="menu-subnav">
                                            ...
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="{{route('finance.brankas.index')}}" class="menu-link">
                                                    <span class="svg-icon menu-icon">
                                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Add-user.svg-->

                                                        <!--end::Svg Icon-->
                                                    </span>
                                                    <span class="menu-text">Safe Deposit</span>
                                                </a>
                                            </li>
                                            <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                            ...
                                            <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                <a href="{{route('docReminder.index')}}" class="menu-link">
                                                        <span class="svg-icon menu-icon">
                                                            <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Add-user.svg-->

                                                            <!--end::Svg Icon-->
                                                        </span>
                                                    <span class="menu-text">Document Validity</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
