@extends('layouts.templateauth', ['img' => asset("images/forgot_success.png"), 'img_size' => "70%", 'offCarousel' => 1])
...
<div class="d-flex flex-center flex-column flex-lg-row-fluid">
    ...
    <div class="w-lg-500px p-10">
        ...
        <div class="mb-11">
            ...
            <!--begin::Title-->
            <h1 class="text-dark fw-bolder mb-3">Password berhasil diatur ulang!</h1>
            <!--end::Title-->
            <!--begin::Subtitle-->
            <div class="text-gray-500 fw-semibold fs-6">
                Silahkan login dengan password barumu
            </div>
            <!--end::Subtitle=-->
        </div>
        <!--begin::Heading-->
