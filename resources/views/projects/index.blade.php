                            ...
                            @foreach($projectsall as $key => $prj_all)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{-- <button type="button" onclick="show_modal('{{$prj_all->id}}')" class="btn btn-link btn-xs"><i class='fa fa-search'></i>&nbsp;&nbsp;{{$prj_all->prj_name}}</button> --}}
                                        <a href="{{ route('marketing.project.view', $prj_all->id) }}">
                                            {{$prj_all->prj_name}}
                                        </a>
                                    </td>
                                    <td class="text-center">
