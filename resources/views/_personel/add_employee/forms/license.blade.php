            ...
            <div class="row" data-form-add>
                <div class="fv-row col-6">
                    <div class="form-group">
                        <label for="" class="col-form-label">License Name</label>
                        <input type="text" name="name[]" data-label class="form-control" placeholder="Input License Name">
                    </div>
                </div>
                <div class="fv-row col-6">
                    <div class="form-group">
                        <label for="" class="col-form-label">License Number</label>
                        <input type="text" name="number[]" class="form-control" placeholder="Input License Number">
                    </div>
                </div>
                <div class="fv-row col-6">
                ...
                <div class="fv-row col-6">
                    <div class="form-group">
                        <label for="" class="col-form-label">Expired Date</label>
                        <input type="date" name="exp_date[]" class="form-control" placeholder="Input Expired Date">
                    </div>
                </div>
            </div>
        </div>
