@if (isset($form_name))
    <div class="fv-row col-12">
        ...
        <div class="position-relative">
            <input type="text" class="form-control find-company pe-15" data-multiple="true" data-name='{{ $form_name }}' placeholder="{{ $placeholder ?? "Input placeholder" }}">
...
<div class="d-flex flex-column">
    ...
    <div class="p-3 rounded bg-white shadow mb-5 shadow-sm">
        <div class="d-flex flex-column justify-content-between">
            <span class="mb-5">Company 1</span>
            <span class="mb-5">Company 2</span>
            <span class="">Company 3</span>
        </div>
    </div>
