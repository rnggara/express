                    ...
                    <div class="d-flex align-items-center">
                        <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                            <div class="symbol-label"
                                style="background-image: url('{{ asset( !empty($company->app_logo) ? "images/$company->app_logo" : "theme/assets/avatars/blank.png") }}?v={{ date("YmdHis") }}')">
                            </div>
                        </div>
                        <div>
                            <a href="#"
                                class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary">{{ $company->company_name }}</a>
                        </div>
                    </div>
                    <div class="py-4">

                    </div>
                    <ul class="nav nav-tabs nav-tabs-line d-flex flex-column">
                        <li class="nav-item mb-2 mr-30 active">
                            <a href="#company-profile" data-bs-toggle="tab" class="nav-link py-4 active">
                        ...
                        <li class="nav-item mb-2 mr-30">
                            <a href="#company-management" data-bs-toggle="tab" class="nav-link py-4">
                                <span class="nav-icon mr-2">
                                    <span class="svg-icon">
                        ...
                        @if(\Config::get("constants.IS_BP") == 1 && \Config::get("constants.ID_MASTER") == \Auth::id())
                        {{-- <li class="nav-item mb-2 mr-30">
                            <a href="#application-management" data-bs-toggle="tab" class="nav-link py-4">
                                <span class="nav-icon mr-2">
                                    <span class="svg-icon">
                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Code/Compiling.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <span class="nav-text font-size-lg">Application Management</span>
                            </a>
                        </li> --}}
                        @endif
                        <li class="nav-item mb-2 mr-30">
                        ...
                        {{-- <li class="nav-item mb-2 mr-30">
                            <a href="{{ route('preference', ['id_company' => base64_encode($company->id)]) }}"
                                class="nav-link py-4">
                                <span class="nav-icon mr-2">
                                    <span class="svg-icon">
                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Code/Compiling.svg-->
                        ...
                        <li class="nav-item mb-2 mr-30">
                            <a href="{{ route('company.role_controll', base64_encode($company->id)) }}"
                                class="nav-link py-4">
                                <span class="nav-icon mr-2">
                                    <span class="svg-icon">
                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Code/Compiling.svg-->
                        ...
                        {{-- <li class="nav-item mb-2 mr-30">
                            <a href="{{ route('config.menu.index', base64_encode($company->id)) }}" class="nav-link py-4">
                                <span class="nav-icon mr-2">
                                    <span class="svg-icon">
                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Code/Compiling.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <span class="nav-text font-size-lg">Config Menu</span>
                            </a>
                        </li> --}}
                    </ul>
                </div>
            ...
            <div class="card card-custom card-stretch">
                <div class="tab-content" id="myTabContent">
                        ...
                        <form class="form">
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-5">
                                    ...
                                    <label
                                        class="col-lg-9 col-xl-6 col-form-label font-weight-bold">{{ $company->address }}</label>
                                </div>
                                <div class="form-group row mb-5">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">NPWP</label>
                                    <label
                                        class="col-lg-9 col-xl-6 col-form-label font-weight-bold">{{ $company->npwp }}</label>
                                </div>
                                <div class="form-group row mb-5">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Phone</label>
                                    <label
                                        class="col-lg-9 col-xl-6 col-form-label font-weight-bold">{{ $company->phone }}</label>
                                </div>
                                <div class="form-group row mb-5">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Email</label>
                                    <label
                                        class="col-lg-9 col-xl-6 col-form-label font-weight-bold">{{ $company->email }}</label>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="tab-pane fade" id="company-management" role="tabpanel">
                        ...
                        <form class="form" method="post" action="{{ route('company.edit') }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-5">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control" type="text" name="company_name"
                                            value="{{ ucwords($company->company_name) }}" />
                                    </div>
                                </div>
                                <div class="form-group row mb-5">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Email</label>
                                ...
                                <div class="form-group row mb-5">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input type="text" name="city" class="form-control"
                                            value="{{ empty($company->city) ? 'JAKARTA' : $company->city }}">
                                    </div>
                                </div>
                                <div class="form-group row mb-5">
                                ...
                                <div class="form-group row mb-5">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control" type="text" name="company_tag"
                                            value="{{ strtoupper($company->tag) }}" />
                                    </div>
                                </div>
                                @if ($company->id != 1)
                                    <div class="form-group row mb-5">
                                                ...
                                                @foreach ($companies as $value)
                                                    @if ($value->id != $company->id)
                                                        <option value="{{ $value->id }}"
                                                            @if ($company->id_parent == $value->id) SELECTED @endif>
                                ...
                                {{-- <div class="form-group row mb-5">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true">
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ str_replace('public', 'public_html', asset('images/' . $company->p_logo)) }}')"></div>
                                ...
                                <div class="form-group row mb-5">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="image-input image-input-outline" data-kt-image-input="true">
                                            <!--begin::Image preview wrapper-->
                                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ str_replace('public', 'public_html', asset('images/' . $company->app_logo)) }}')"></div>
                                            <!--end::Image preview wrapper-->
                                ...
                                {{-- <div class="form-group row mb-5">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Application Logo
                                        White</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="image-input image-input-outline bg-dark" id="p_logo_white">
                                            <div class="image-input-wrapper"
                                                style="background-image: url('{{ str_replace('public', 'public_html', asset('images/' . $company->p_logo_white)) }}'); width: 768px; background-size: contain;">
                                            </div>
                                            <label
                                                ...
                                                <input type="file" name="p_logo_white" id="p_logo_white"
                                                    accept=".png, .jpg, .jpeg" />
                                        ...
                                        <span class="form-text text-muted">
                                            This logo will be displayed in the Cypher application, we recommend using a
                                            square shaped logo. <br />
                                            Allowed file types: png, jpg, jpeg.
                                        </span>
                                    </div>
                                </div> --}}
                                {{-- <div class="form-group row mb-5">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Application
                                        Background</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="image-input image-input-outline" id="p_background">
                                            <div class="image-input-wrapper"
                                                style="background-image: url('{{ str_replace('public', 'public_html', asset('images/' . $company->p_bg)) }}'); width: 768px; height: 480px">
                                            </div>
                                            <label
                                                class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                                                data-action="change" data-toggle="tooltip" title=""
                                                data-original-title="Change">
                                                <i class="fa fa-pen icon-sm text-muted"></i>
                                                <input type="file" name="p_background" id="p_background"
                                                    accept=".png, .jpg, .jpeg" />
                                                <input type="hidden" name="ap_logo_remove" />
                                            </label>
                                            <span
                                ...
                                <div class="form-group row mb-5">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Application Background Width
                                        (%)</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <input type="number" class="form-control" min="50" max="100"
                                            name="p_bg_width"
                                            value="{{ empty($company->p_bg_width) ? 100 : $company->p_bg_width }}">
                                    </div>
                                </div>
                                <div class="form-group row mb-5">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input type="text" class="form-control" name="p_title"
                                            ...
                                            value="{{ empty($company->p_title) ? 'CYPHER - ERP' : $company->p_title }}">
                                    </div>
                                </div>
                                <div class="form-group row mb-5">
                                ...
                                @if ($company->id_parent != null)
                                    <div class="form-group row mb-5">
                                        <label class="col-xl-3 col-lg-3 col-form-label text-right">Inherit to
                                            parent</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="checkbox-inline col-form-label">
                                                <label class="checkbox checkbox-outline checkbox-success">
                                                    <input type="checkbox" {{ $company->inherit == 1 ? 'checked' : '' }}
                                                        value="1" name="inherit" />
                                                    <span></span>
                                ...
                                <div class="form-group row mb-5">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <button type="submit" name="editProfile" class="btn btn-primary"><i
                    ...
                    @if(\Config::get("constants.IS_BP") == 1 && \Config::get("constants.ID_MASTER") == \Auth::id())
                    <div class="tab-pane fade" id="application-management" role="tabpanel">
                        <div class="card-header bg-transparent">
                            <h3 class="card-title">Application Management</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('company.app_edit') }}" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="app_name" class="col-form-label">Application Name</label>
                                    <input type="text" name="app_name" id="app_name" class="form-control"
                                        value="{{ env('APP_LABEL') }}">
                                </div>
                                <div class="form-group">
                                    <label for="app_icon" class="col-form-label w-100">Application Logo</label>
                                    <!--begin::Image input-->
                                    <div class="image-input image-input-empty" data-kt-image-input="true">
                                        <!--begin::Image preview wrapper-->
                                        <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ asset(\Config::get("constants.APP_ICON")) }})"></div>
                                        <!--end::Image preview wrapper-->
