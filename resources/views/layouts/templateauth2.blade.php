    ...
    <div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
        ...
        <div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-color: #000;">
            ...
            <div class="d-flex flex-column justify-content-center text-center pt-lg-40 pt-md-5 pt-sm-5 px-lg-0 pt-5 px-7" style="background-color: #000000;">
                <h3 class="display4 font-weight-bolder my-7 text-white" style="color: #ffffff;">@yield('p_title')</h3>
                @yield('p_subtitle')
            </div>
            <!--end::Title-->
            <!--begin::Image-->
            <div class="content-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center" style="background-image: url(@yield('p_bg')); background-size: @yield('p_bg_width')%; object-fit: fill">
