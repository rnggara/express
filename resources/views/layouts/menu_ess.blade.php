<a href="{{ route('ess.profile.index') }}"
    ...
    <span class="d-none d-md-inline">{{ __('Profil') }}</span>
</a>
<a href="{{ route("ess.attendance.index") }}"
    class="btn btn-flex btn-active-color-primary align-items-cenrer justify-content-center justify-content-md-between align-items-lg-center flex-md-content-between bg-opacity-10 px-0 ps-md-6 pe-md-5 h-30px h-md-35px">
    <span class="d-none d-md-inline">{{ __('Kehadiran') }}</span>
</a>
...
<a href="{{ route('ess.benefit.index') }}"
    class="btn btn-flex btn-active-color-primary align-items-cenrer justify-content-center justify-content-md-between align-items-lg-center flex-md-content-between bg-opacity-10 px-0 ps-md-6 pe-md-5 h-30px h-md-35px">
    <span class="d-none d-md-inline">{{ __('Remunerasi') }}</span>
</a>
<a href="{{ route('ess.team.index') }}"
    class="btn btn-flex btn-active-color-primary align-items-cenrer justify-content-center justify-content-md-between align-items-lg-center flex-md-content-between bg-opacity-10 px-0 ps-md-6 pe-md-5 h-30px h-md-35px">
    <span class="d-none d-md-inline">{{ __('Tim Saya') }}</span>
</a>
