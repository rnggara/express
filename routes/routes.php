...
Route::get('/assign-ft/{m}', "FinanceTreasuryController@_assign_ft");
Route::get('/home', 'HomeController@index')->name('home');
Route::get('/home/get-company/{id?}', 'Auth\LoginController@get_company')->name('home.get_company');

Route::get("/modal-pdf/{file_name?}", "HomeController@modal_pdf")->name("modal.pdf");

Route::get("/config-menu", "ConfigMenu@index")->name("config.menu.index");
Route::get("/config-menu/toggle/{id?}", "ConfigMenu@toggle")->name("config.menu.toggle");
Route::post("/config-menu/rc/update", "ConfigMenu@rc_update")->name("config.menu.rc_update");

Route::get('/forbidden-403', "HomeController@forbidden_access")->name("forbidden");
...
Route::get("/notification-list", "HomeController@notif_list")->name("notif.list");
Route::get("/notification-list/view/{id?}", "HomeController@notif_view")->name("notif.view");
...
Route::post("/company/application/edit", 'CompanyController@app_edit')->name('company.app_edit');
Route::get('/company/role-control/{id}', 'CompanyController@role_controll')->name('company.role_controll');
Route::get("/company/structure/{id}", 'CompanyController@st')->name('company.st');
...
Route::get("/rprivilege/excel", "RoleDivController@excel")->name("rprivilege.excel");
...
//Career Path
Route::prefix("/preference/career-path")->group(function(){
    Route::get("/{id}", 'CareerPathController@index')->name("cp.index");
    Route::get('/edit/{id?}', 'CareerPathController@edit')->name("cp.edit");
    Route::get('/get/{id?}', 'CareerPathController@get')->name("cp.get");
    Route::get('/delete/{id?}', 'CareerPathController@delete')->name("cp.delete");
    Route::post("/add", "CareerPathController@add")->name("cp.add");
    Route::post("/update", "CareerPathController@update")->name("cp.update");

    Route::get("/order/{type}/{id}", "CareerPathController@order")->name("cp.order");
});
...
Route::get('/hrd/employee/expel/{id?}', 'HrdEmployeeController@expel_emp')->name('employee.expel.get');
...
Route::get("/hrd/employee/fired-confirmation/{id}", "HrdEmployeeController@fired_confirmation")->name("employee.fired.confirmation");
Route::post('/hrd/employee/finalize-expel/{id}', 'HrdEmployeeController@expelEmp')->name('employee.expel');
Route::get("/hrd/employee-approval/", "HrdEmployeeController@salary_approval")->name("employee.salary.approval");
Route::get("/hrd/employee-approval/delete/{id}", "HrdEmployeeController@salary_approval_delete")->name("employee.salary.approval.delete");
Route::get("/hrd/employee-approval/approve/{id}", "HrdEmployeeController@salary_approval_approve")->name("employee.salary.approval.approve");
Route::get("/hrd/employee-approval/send-email/{id}", "HrdEmployeeController@salary_approval_email")->name("employee.salary.approval.email");
Route::post('/hrd/employee-approval/approve/{id}', "HrdEmployeeController@salary_approval_post")->name("employee.salary.approval.post");
Route::get("/hrd/employee/freeze-update/{id?}", "HrdEmployeeController@freeze_update")->name("employee.freeze");
Route::get("/hrd/employee/export", "HrdEmployeeController@export_emp");
Route::get("/hrd/employee/report", "HrdEmployeeController@report_emp")->name("employee.report.view");
Route::post("/hrd/employee/report", "HrdEmployeeController@report_emp_post")->name("employee.report.post");
    Route::get('/hrd/employee/grade/{type}/{id}', "HrdEmployeeController@grade_change")->name("employee.grade.change");
Route::post("/hrd/employee/grade/submit", "HrdEmployeeController@grade_submit")->name("employee.grade.submit");
Route::get("/hrd/employee/career-path", "HrdEmployeeController@career_path")->name("employee.career.index");
Route::get("/hrd/employee/career-path/detail/{id}", "HrdEmployeeController@career_path_detail")->name("employee.career.detail");
Route::get("/hrd/employee/career-path/delete/{id}", "HrdEmployeeController@career_path_delete")->name("employee.career.delete");
Route::post("/hrd/employee/career-path/approve", "HrdEmployeeController@career_path_approve")->name("employee.career.approve");
Route::get("/hrd/employee/performance-bonus", "HrdEmployeeController@pb")->name("employee.pb.index");
Route::post("/hrd/employee/performance-bonus", "HrdEmployeeController@pb_update")->name("employee.pb.post");
...
Route::post('/hrd/employee/file_category', 'HrdEmployeeController@file_category')->name('employee.file_category');
...
Route::get("/hrd/employee/bank/{id}", "HrdEmployeeController@bank_emp")->name("employee.bank");
Route::get("/hrd/employee/bank-delete/{id}", "HrdEmployeeController@bank_emp_delete")->name("employee.bank.delete");
Route::post("/hrd/employee/bank/add", "HrdEmployeeController@bank_emp_add")->name("employee.bank.add");

Route::post("/hrd/employee/pension/plan", "HrdEmployeeController@pension_plan")->name("employee.pension.plan");
Route::get("/hrd/employee/pension/issue/{type?}/{id?}", "HrdEmployeeController@pension_issue")->name("employee.pension.issue");
Route::get("/hrd/employee/pension/cancel/{id}", "HrdEmployeeController@pension_cancel")->name("employee.pension.cancel");

Route::get("/hrd/employee/user-outstanding", "HrdEmployeeController@user_outstanding")->name("employee.user.outstanding");
Route::post("/hrd/employee/user-outstanding", "HrdEmployeeController@user_outstanding_update")->name("employee.user.update");
...
Route::get('/hrd/employee/loan/{id}/approval', 'HrdEmployeeController@approvalLoan')->name('employee.loan.approval');
Route::post('/hrd/employee/loan-approve', 'HrdEmployeeController@approve_loan')->name('employee.loan.approve_loan');
...
// PAYROLL
Route::get('/hrd/payroll/{code?}', 'HrdPayrollController@index')->name('payroll.index');
Route::post('/hrd/payroll', 'HrdPayrollController@show')->name('payroll.show');
Route::post('/hrd/payroll-btl/export', 'HrdPayrollController@export')->name('payroll.export');
Route::get('/hrd/payroll-btl/remarks-btl', 'HrdPayrollController@print_btl')->name('payroll.remarks_btl');
Route::get('/hrd/payroll-btl/print-btl', 'HrdPayrollController@print_btl')->name('payroll.print_btl');
...
Route::post('/hrd/payroll/share', "HrdPayrollController@share_payroll")->name("payroll.share");

// NEW PAYROLL
Route::prefix("/hrd/payroll-new")->group(function(){
    Route::get('/{code?}', 'HrdNewPayrollController@index')->name('payroll_new.index');
    Route::post('', 'HrdNewPayrollController@show')->name('payroll_new.show');
    Route::post('/btl/export', 'HrdNewPayrollController@export')->name('payroll_new.export');
    Route::get('/btl/remarks-btl', 'HrdNewPayrollController@print_btl')->name('payroll_new.remarks_btl');
    Route::get('/btl/print-btl', 'HrdNewPayrollController@print_btl')->name('payroll_new.print_btl');
    Route::post('/update', 'HrdNewPayrollController@update')->name('payroll_new.update');
    Route::post('/remarks-save', 'HrdNewPayrollController@save_remarks')->name('payroll_new.remarks_save');
    Route::post('/total-payroll', 'HrdNewPayrollController@get_total_payroll')->name('payroll_new.get.total');
    Route::post('/share', "HrdNewPayrollController@share_payroll")->name("payroll_new.share");
    Route::get('/slip/{id?}/{period?}', 'HrdNewPayrollController@print_new_slip')->name('payroll_new.slip.print');
});
...
Route::get('/hrd/payroll/new-slip/{id?}/{period?}', 'HrdPayrollController@print_new_slip')->name('payroll.new_slip.print');
...
Route::get('/qhse/mcu/log-delete/{id}','MCUController@deleteLog')->name('mcu.logs.delete');
...
Route::get('/general/safety-meeting/emp/{id?}', 'SafetyMeetingController@getEmp')->name("sm.getEmp");
Route::post("/general/safety-meeting/absence/confirm", "SafetyMeetingController@confirm_attend")->name("sm.confirm");
Route::get('/general/safety-meeting/print/{id?}','SafetyMeetingController@printMv')->name('sm.printMv');
...
Route::get('/general/management-visit/emp/{id?}', 'ManagementVisitController@getEmp')->name("mv.getEmp");
Route::post("/general/management-visit/absence/confirm", "ManagementVisitController@confirm_attend")->name("mv.confirm");
...
//quotation
Route::prefix("/marketing/quotation")->group(function(){
    Route::get("/", "MarketingQuotation@index")->name("marketing.quotation.index");
    Route::get('/add', "MarketingQuotation@add")->name("marketing.quotation.add");
    Route::get('/edit/{id}', "MarketingQuotation@edit")->name("marketing.quotation.edit");
    Route::get('/detail/{id}', "MarketingQuotation@detail")->name("marketing.quotation.detail");
    Route::get('/delete/{id}', "MarketingQuotation@delete")->name("marketing.quotation.delete");

    Route::post('/store', "MarketingQuotation@store")->name("marketing.quotation.store");
    Route::post('/update/{id}', "MarketingQuotation@update")->name("marketing.quotation.update");
});
...
Route::post("/marketing/projects/prep/add", 'MarketingProjectsController@prep_add')->name("marketing.project.prep.add");
Route::get("/marketing/projects/prep/set", 'MarketingProjectsController@prep_appr')->name("marketing.project.prep.appr");
...
Route::get('/marketing/prognosis/actual-cost/{project}/{id?}', "MarketingPrognosisController@actual_cost")->name("marketing.prognosis.actual_cost");
...
Route::get('/general/wo/export/{type?}', 'AssetWoController@export')->name('wo.export');
...
Route::post("/general/to/set-date/", "GeneralTravelOrderController@set_date")->name("to.set.date");
...
Route::post('/procurement/vendpr/rate', 'ProcurementVendorController@rate')->name("vendor.rate");
...
Route::get('/general/ir/items/assign-do/{id?}','AssetPreController@assign_do')->name('fr.assign.do');
Route::post('/general/ir/items/assign-do/{id?}','AssetPreController@assign_post_do')->name('fr.assign_post.do');
Route::get('/general/ir/items/item-do/{id?}','AssetPreController@item_do')->name('fr.item.do');
...
Route::get('/general/pe/view/{id}', 'AssetPreController@pc_apprPev')->name('pe.view');
...
Route::post('/general/po/lists/{category?}', 'AssetPoController@lists')->name('po.list');
...
Route::get('/general/po/export/{type?}', 'AssetPoController@export')->name('po.export');
...
Route::get("/finance/treasury/set/{status?}", 'FinanceTreasuryController@set_status')->name('treasury.set_status');

Route::get("/finance/treasury/hold-amount/{id}", "FinanceTreasuryController@hold_amount_index")->name("treasury.hold_amount");
Route::get("/finance/treasury/hold-amount-delete/{id}", "FinanceTreasuryController@hold_amount_delete")->name("treasury.hold_amount_delete");
Route::post("/finance/treasury/hold-amount/{id}", "FinanceTreasuryController@hold_amount")->name("treasury.hold_amount_post");

Route::get("/finance/treasury/assign-tc/{year}/{month}", "FinanceTreasuryController@assign_tc")->name("treasury.assign_tc");
Route::get("/finance/treasury/opening-balance/{year}", "FinanceTreasuryController@opening_balance");
...
Route::post('finance/treasure-sp/generate-sp','FinanceTreasureSpController@generate_sp')->name('treasure.sp.generate_sp');
...
Route::get('/general/mom/emp/{id?}', 'MOMController@getEmp')->name("mom.getEmp");
Route::post("/general/mom/absence/confirm", "MOMController@confirm_attend")->name("mom.confirm");
...
//Asset Galery
Route::get("/general/asset-gallery", "GeneralDocumentsController@ag_index")->name("ag.index");
Route::get("/general/asset-gallery/view/{id}", "GeneralDocumentsController@ag_view")->name("ag.view");
...
Route::post('/finance/profit-loss', 'FinanceProfitLossController@index')->name('pl.index');
...
Route::post('/finance/invoice-in/', 'FinanceInvoiceIn@list')->name('inv_in.list');
...
Route::post("/finance/invoice-out/save-date/{type?}", 'FinanceAccountReceivable@save_date')->name('ar.date.save');
Route::post("/finance/invoice-out/update-payment-date", 'FinanceAccountReceivable@update_date')->name('ar.date.update');
...
Route::post("/finance/loan/add-detail/{id}", 'FinanceLoanController@add_detail')->name('loan.add_detail');
Route::get("/finance/loan/delete-detail/{id}", 'FinanceLoanController@delete_detail')->name('loan.delete_detail');
...
Route::get("/finance/utilization/get-periode/{id?}", 'FinanceUtilizationController@get_periode')->name('util.get_periode');
Route::post("/finance/utilization/update-periode", 'FinanceUtilizationController@update_periode')->name('util.update_periode');
...
Route::post("/finance/business/lock", "FinanceBusinessController@lock_bs")->name("business.lock");

Route::get('/finance/business/detail-close/{id?}', 'FinanceBusinessController@detail_close')->name('business.detail_close');
Route::get('/finance/business/detail-force-close/{id?}', 'FinanceBusinessController@detail_force_close')->name('business.detail_force_close');
...
Route::get("/finance/business/investors/list/{id?}/{type?}", 'FinanceBusinessController@investors_list')->name("business.investors.list");
...
Route::prefix('/finance/po-wo/setting')->group(function(){
    Route::get("/", "HAPoWoTypesController@setting")->name("ha.powo.setting");
    Route::post("/add", "HAPoWoTypesController@setting_add")->name("ha.powo.setting_add");
});
...
Route::get("/general/do/gate", 'GeneralDOController@getDOGate')->name('do.detail.gate');
...
Route::post('/general/wo/lists/{category?}', 'AssetWoController@lists')->name('wo.list');
Route::post('/dirut/preference/accounting', 'PreferenceController@accounting_save')->name('pref.accounting.save');
Route::post('/dirut/preference/asset', 'PreferenceController@asset_save')->name('pref.asset.save');
...
Route::post('/dirut/preference/holiday', 'PreferenceController@holiday_save')->name('pref.holiday.save');
Route::post('/dirut/preference/test', 'PreferenceController@test_save')->name('pref.test.save');
Route::get('/dirut/preference/holiday/event/{id?}', 'PreferenceController@holiday_event')->name('pref.holiday.event');
Route::get('/dirut/preference/holiday/delete/{id?}', 'PreferenceController@holiday_delete')->name('pref.holiday.delete');

Route::post("/dirut/preference/uom/store/{id?}", "PreferenceController@uom_store")->name("pref.uom.store");
Route::get("/dirut/preference/uom/delete/{id?}", "PreferenceController@uom_delete")->name("pref.uom.delete");

Route::get("/dirut/preference-request/", "PreferenceController@request_view")->name("pref.req.index");
Route::post("/dirut/preference-request/", "PreferenceController@request_post")->name("pref.req.post");

Route::post('/dirut/preference-add-tax/{act?}', "PreferenceController@submit_tax")->name("pref.tax.submit");

Route::get('/dirut/preference-print/{id}', 'PreferenceController@automatic_print')->name("pref.automatic.print");

Route::post('/dirut/preference-email/add', 'PreferenceController@add_email')->name("pref.email.add");
Route::get("/dirut/preference-email/delete/{id}", 'PreferenceController@delete_email')->name("pref.email.delete");
Route::post("/dirut/preference-email/update", 'PreferenceController@update_email')->name("pref.email.update");

Route::get("/dirut/preference/{id}/bank-list", "PreferenceController@view_bank")->name("pref.bank.view");
Route::post("/dirut/preference/bank-priority", "PreferenceController@add_priority")->name("pref.priority.bank");
Route::post('/dirut/preference-bank/add', 'PreferenceController@add_bank')->name("pref.bank.add");
Route::get('/dirut/preference-bank/delete/{id}', 'PreferenceController@delete_bank')->name("pref.bank.delete");
Route::get('/dirut/preference-bank/priority/{type}/{id}', 'PreferenceController@priority_bank')->name("pref.bank.priority");
...
Route::prefix("hrd/event")->group(function(){
    Route::get('/', 'HrdEventController@index')->name('event.index');
    Route::get("/detail/{id}", 'HrdEventController@detail')->name('event.detail');
    Route::get("/delete/{id}", 'HrdEventController@delete')->name('event.delete');
    Route::get("/phase/{num}/{id}", 'HrdEventController@phase')->name('event.phase');
    Route::get("/phase-delete/{type}/{id}", 'HrdEventController@delete_detail')->name('event.delete_detail');
    Route::get('/done/{id}', 'HrdEventController@set_done')->name('event.set_done');

    Route::post('/add', 'HrdEventController@add')->name('event.add');
    Route::post("/add/{type}", 'HrdEventController@add_detail')->name('event.add_detail');
    Route::post("/edit/{type}", 'HrdEventController@edit_detail')->name('event.edit_detail');
});
...
Route::get("item/qrcode-print-view", "BarcodeGenerate@print_view")->name("barcode.print.view");
Route::get("item/qrcode-print", "BarcodeGenerate@print")->name("barcode.print");
