...
<div class="d-flex flex-column">
    <div class="d-flex align-items-center justify-content-between">
        ...
        <div>
            <a href="https://intranet.kerjaku.cloud" class="btn btn-sm btn-primary">
                ...
                <div class="d-flex">
                    <ul class="nav border-0 flex-row flex-md-column me-5 mb-3 mb-md-0 fs-6">
                        <li class="nav-item w-md-200px">
                            <a class="nav-link text-active-primary text-dark" data-bs-toggle="tab" href="#kt_vtab_pane_3">
                                                ...
                                                <div class="d-flex align-items-start rounded border bg-white p-5">
                                                    <div class="form-check me-3">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" {{ empty($form['approved_at']) ? "" : "checked" }} onclick="onboardAction('task_appr', '{{ $form['id'] }}', this)" type="checkbox" value="1" />
                                                        </label>
                                                    </div>
                                                    <div class="d-flex flex-column">
                                                        <span class="fs-3">{{ $form['form_name'] }}</span>
                                                        <span class="text-muted my-3">{{ $form['form_descriptions'] }}</span>
                                                        <div class="fv-row">
                                                            <div class="d-flex align-items-center mb-3">
                                                                <label class="btn btn-{{ empty($form['file_name']) ? 'secondary' : "primary" }}">
                                                                    <input type="file" name="attachment" onchange="onboardAction('task', '{{ $form['id'] }}', this)" accept=".pdf, .jpg, .png" data-attachment class="d-none">
