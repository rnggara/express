...
@section('view_content')
        ...
        <div class="card">
            <div class="card-header border-bottom-0 px-0">
                <div class="d-flex flex-column">
                    ...
                    <span>Detail dan aturan agama</span>
                    {{-- <div class="d-flex align-items-center mb-5">
                        ...
                        <span class="fw-semibold">Agama</span>
                    </div> --}}
                </div>
            </div>
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route("crm.pref.personel.religion.post") }}" method="post">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <div class="d-flex flex-column align-items-center">
                                                                ...
                                                                <span class="text-center">make sure Agama not used to employee</span>
                                        ...
                                        <form action="{{ route("crm.pref.personel.religion.post") }}" method="post">
                                            @component('layouts._crm_modal', [
                                                ...
                                                @slot('modalTitle')
                                                    <div class="d-flex flex-column">
                                                        <span class="fs-1 fw-bold">Edit Agama</span>
                                                        <span class="fs-base fw-normal mt-2">Fill the form to set employee Agama</span>
                                                    </div>
                                                @endslot
                                                @slot('modalContent')
                                                    <div class="fv-row">
                                                    ...
                                                    <div class="fv-row">
                                                        ...
                                                        <input type="text" name="description" value="{{ $item->name }}" placeholder="Example: Islam, Kristen, Katolik, and others" class="form-control">
                                                        @error('description')
                                                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                                                {{ $message }}
                                                            </div>
    ...
    <form action="{{ route("crm.pref.personel.religion.post") }}" method="post">
        @component('layouts._crm_modal', [
            ...
            @slot('modalTitle')
                <div class="d-flex flex-column">
                    <span class="fs-1 fw-bold">Tambah Agama</span>
                    <span class="fs-base fw-normal mt-2">Fill the form to set employee Agama</span>
                </div>
            @endslot
            @slot('modalContent')
                ...
                <div class="fv-row">
                    <label class="col-form-label required">Description</label>
                    <input type="text" name="description" value="{{ old('description') }}" placeholder="Example: Islam, Kristen, Katolik, and others" class="form-control">
                    @error('description')
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            {{ $message }}
                        </div>
