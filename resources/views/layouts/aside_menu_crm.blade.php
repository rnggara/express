{{-- <a href="{{ route('crm.index') }}"
    ...
    <span class="d-inline">{{ __('Dashboard') }}</span>
</a> --}}
@hasPermission("crm", "view", "opportunity")
<a href="{{ route('crm.lead.index') }}"
    class="btn btn-flex mb-5 btn-active-color-primary align-items-cenrer justify-content-center justify-content-md-between align-items-lg-center flex-md-content-between bg-opacity-10 px-0 ps-md-6 pe-md-5 h-30px h-md-35px">
    <span class="d-inline">{{ __('Opportunity') }}</span>
</a>
@endPermission
<div>
    <button type="button"
        ...
        <span class="d-inline">{{ __('List') }}</span>
...
<a href="{{ route('crm.products.index') }}"
    class="btn btn-flex mb-5 btn-active-color-primary align-items-cenrer justify-content-center justify-content-md-between align-items-lg-center flex-md-content-between bg-opacity-10 px-0 ps-md-6 pe-md-5 h-30px h-md-35px">
    <span class="d-inline">{{ __('Product') }}</span>
</a>
@endPermission
@hasPermission("crm", "view", "archive")
<a href="{{route('crm.archive.index')}}"
    class="btn btn-flex mb-5 btn-active-color-primary align-items-cenrer justify-content-center justify-content-md-between align-items-lg-center flex-md-content-between bg-opacity-10 px-0 ps-md-6 pe-md-5 h-30px h-md-35px">
    <span class="d-inline">{{ __('Archive') }}</span>
</a>
@endPermission
{{-- <a href="{{ route('crm.pref.index') }}"
    class="btn btn-flex mb-5 btn-active-color-primary align-items-cenrer justify-content-center justify-content-md-between align-items-lg-center flex-md-content-between bg-opacity-10 px-0 ps-md-6 pe-md-5 h-30px h-md-35px">
    <span class="d-inline">{{ __('Setting') }}</span>
</a> --}}
