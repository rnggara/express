        ...
        <div class="tab-content scroll" id="myTabContent" style="padding: 0">
            <div class="tab-pane fade {{ $t == "perusahaan" ? "show active" : "" }}" id="tab_company" role="tabpanel">
                <div class="d-flex flex-column gap-3">
                    <div class="d-flex flex-column accordion mb-5" id="accordion-table-perusahaan" data-select2-id="select2-data-accordion-table-perusahaan">
                        <div class="d-flex align-items-center justify-content-start"><div id="table-perusahaan_filter" class="dataTables_filter">
                            <label class="d-lg-block d-none mb-5 mb-lg-0 position-relative w-100">
                                <i class="fs-3 fa fa-search ms-4 position-absolute text-gray-500 top-50 translate-middle-y"></i>
                                <input type="search" class="form-control form-control-sm ps-10" placeholder="Cari perusahaan" aria-controls="table-perusahaan">
                            </label>
                        </div>
                        <div class="d-none d-md-inline ms-5"></div>
                        <button class="btn d-none d-md-inline btn-secondary btn-sm ms-5 collapsed" data-bs-toggle="collapse" data-bs-target="#filter-by-column-table-perusahaan" aria-expanded="false">
                            <i class="la la-filter fs-2"></i> Filter</button>
                        </div>
                        <div class="row align-items-center w-100 collapse mt-5" id="filter-by-column-table-perusahaan" data-bs-parent="accordion-table-perusahaan" data-select2-id="select2-data-filter-by-column-table-perusahaan" style="">
                            <div class="d-flex justify-content-between gap-3">
                                <select name="type" data-allow-clear="true" data-col-target="3" class="form-select" data-control="select2" data-placeholder="Type" id="">
                                    <option value=""></option>
                                ...
                                <select name="created" data-allow-clear="true" data-col-target="4" class="form-select" data-control="select2" data-placeholder="Created By" id="">
                                    <option value=""></option>
                                    @foreach ($created_by['company'] as $item)
                                        @if (isset($users[$item]))
                                            <option value="{{ $users[$item] }}">{{ $users[$item] }}</option>
                                        @endif
                                    @endforeach
                                </select>
                                <select name="complete" data-allow-clear="true" data-col-target="7" class="form-select" data-control="select2" data-placeholder="Completeness of Data" id="">
                                    <option value=""></option>
                    ...
                    <table class="table bg-white display-list" data-col-name="['name', 'contact', 'client', 'type', 'created', 'updated', 'action', 'completeness']" data-exclude='[2,4]' data-col-filter="3,4" id="table-perusahaan">
                        <thead>
                            <tr>
                                <th>Perusahaan</th>
                                <th>Kontak</th>
            ...
            <div class="tab-pane fade {{ $t == "kontak" ? "show active" : "" }}" id="tab_kontak" role="tabpanel">
                <div class="d-flex flex-column gap-3">
                    <div class="d-flex flex-column accordion mb-5" id="accordion-table-kontak" data-select2-id="select2-data-accordion-table-kontak">
                        <div class="d-flex align-items-center justify-content-start"><div id="table-kontak_filter" class="dataTables_filter">
                            <label class="d-lg-block d-none mb-5 mb-lg-0 position-relative w-100">
                                <i class="fs-3 fa fa-search ms-4 position-absolute text-gray-500 top-50 translate-middle-y"></i>
                                <input type="search" class="form-control form-control-sm ps-10" placeholder="Cari kontak" aria-controls="table-kontak">
                            </label>
                        </div>
                        <div class="d-none d-md-inline ms-5"></div>
                        <button class="btn d-none d-md-inline btn-secondary btn-sm ms-5 collapsed" data-bs-toggle="collapse" data-bs-target="#filter-by-column-table-kontak" aria-expanded="false">
                            <i class="la la-filter fs-2"></i> Filter</button>
                        </div>
                        <div class="row align-items-center w-100 collapse mt-5" id="filter-by-column-table-kontak" data-bs-parent="accordion-table-kontak" data-select2-id="select2-data-filter-by-column-table-kontak" style="">
                            <div class="d-flex justify-content-between gap-3">
                                <select name="type" data-allow-clear="true" data-col-target="4" class="form-select" data-control="select2" data-placeholder="Type" id="">
                                    <option value=""></option>
                                    <option value="Competitor">Competitor</option>
                                    <option value="Lead">Lead</option>
                                    <option value="Customer">Customer</option>
                                ...
                                {{-- <select name="created" data-allow-clear="true" data-col-target="4" class="form-select" data-control="select2" data-placeholder="Created By" id="">
                                    <option value=""></option>
                                    @foreach ($created_by['contacts'] as $item)
                                        @if (isset($users[$item]))
                                            <option value="{{ $users[$item] }}">{{ $users[$item] }}</option>
                                        @endif
                                    @endforeach
                    ...
                    <table class="table bg-white table-striped display-list" data-col-name="['name', 'posisi', 'phone', 'email', 'type', 'updated', 'action', 'completeness']" data-col-filter="4" id="table-kontak">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Posisi</th>
            ...
            <div class="tab-pane fade {{ $t == "file" ? "show active" : "" }}" id="tab_files" role="tabpanel">
                <div class="d-flex flex-column gap-3">
                    <div class="d-flex flex-column accordion mb-5" id="accordion-table-file" data-select2-id="select2-data-accordion-table-file">
                        <div class="d-flex align-items-center justify-content-start"><div id="table-file_filter" class="dataTables_filter">
                            <label class="d-lg-block d-none mb-5 mb-lg-0 position-relative w-100">
                                <i class="fs-3 fa fa-search ms-4 position-absolute text-gray-500 top-50 translate-middle-y"></i>
                                <input type="search" class="form-control form-control-sm ps-10" placeholder="Cari file" aria-controls="table-file">
                            </label>
                        </div>
                        <div class="d-none d-md-inline ms-5"></div>
                        <button class="btn d-none d-md-inline btn-secondary btn-sm ms-5 collapsed" data-bs-toggle="collapse" data-bs-target="#filter-by-column-table-file" aria-expanded="false">
                            <i class="la la-filter fs-2"></i> Filter</button>
                        </div>
                        <div class="row align-items-center w-100 collapse mt-5" id="filter-by-column-table-file" data-bs-parent="accordion-table-file" data-select2-id="select2-data-filter-by-column-table-file" style="">
                            <div class="d-flex justify-content-between gap-3">
                                <select name="type" data-allow-clear="true" data-col-target="1" class="form-select" data-control="select2" data-placeholder="Type" id="">
                                    <option value=""></option>
                    ...
                    <table class="table bg-white table-striped display-list" data-col-name="['name', 'type', 'file', 'url', 'related_to', 'updated', 'action', 'completeness']" data-col-filter="1, 2" id="table-file">
                        <thead>
                            <tr>
                                <th>File Name</th>
                                <th>File Type</th>
...
<div class="modal fade" tabindex="-1" id="modalOp">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body p-0">
...
@section('custom_script')
    ...
    <script>
        ...
        function openDet(type, id){
            $("#modalOp div.modal-body").html("")
            $.ajax({
                url : "{{ route("crm.list.index") }}?a=det&type="+type+"&id="+id,
                type : "get",
                dataType : "json"
            }).then(function(resp){
                $("#modalOp div.modal-body").html(resp.view)

                $("#modalOp").modal("show")

                $("#modalOp [data-bs-toggle=tooltip]").tooltip()
            })
        }

        $("table.display-list").each(function(table_index){
            var id = $(this).attr("id")
            var dataCol = $(this).data("col-name") ?? "[]"
            var colDef = JSON.parse(dataCol.replaceAll("'", "\""))
            var coldefs = []
            ...
            table_list[id] = $(this).DataTable({
                ...
                dom : `<"d-flex flex-column"<"d-flex align-items-center justify-content-start"<"d-none d-md-inline ms-5">>>t<"row"<"col-sm-12 col-md-5 d-flex align-items-center justify-content-center justify-content-md-start"<"dataTable-length-info-label me-3">l><"col-sm-12 col-md-7 d-flex align-items-center"p>>`,
                ...
                columns : coldefs ?? null,
                ajax : coldefs.length == 0 ? null : {
                    url : "{{ route("crm.list.index") }}?a=" + id,
                    type : "get",
                    dataType : "json"
                },
            ...
            var par = $(this).parents("div.flex-column").eq(0)
            var search = $(par).find('[aria-controls="'+id+'"]')
            $(search).on("keyup", function(e){
                if(e.keyCode === 13){
                    table_list[id].search($(this).val()).draw()
                }
            })
            ...
            var sels = $(par).find('[data-col-target]')
            $(sels).change(function(){
                var tgt = $(this).data("col-target")
                table_list[id].column(tgt).search($(this).val()).draw()
            })
        })
        ...
        function change_tab(btn){
            ...
            let stateObj = { id: {{ Auth::id() }} };

            window.history.pushState(stateObj,
                "Page 2", "{{ route("crm.list.index") }}?t=" + btn);
        }
