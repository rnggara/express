            ...
            <div class="card-header border-bottom-0 px-0">
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <a href="{{ route("crm.pref.company.departement.index", base64_encode($company->id)) }}" class="text-muted">Departement <i class="fa fa-chevron-right mx-3 text-dark-75"></i></a>
            ...
            <div class="card-body rounded bg-secondary-crm">
                <div class="d-flex flex-column">
                    <div class="d-flex align-items-center justify-content-between mb-5">
                        <a href="{{ route("crm.pref.company.departement.index", base64_encode($company->id)) }}" class="btn btn-sm btn-primary">
...
<script>
    $(document).ready(function(){
        ...
        console.log(subLevel, maxLevel)

        $.ajax({
            url : "{{ route("crm.pref.company.departement.structure", base64_encode($company->id)) }}",
            method : "GET",
            data : {
                a : "tree"
            },
            ...
            success : function(data){
                ...
                OrgChart.templates.myTemplate.field_0 = '<text width="210" class="field_0" style="font-size: 16px;" font-weight="bold" fill="#fff" x="150" y="30" text-anchor="middle">{val}</text>';
