        ...
        <div class="card mb-8">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center flex-column flex-md-row">
                    <span class="fw-bold fs-1">Job Ad Report</span>
                ...
                <div class="d-flex flex-column">
                    <div class="d-flex align-items-center justify-content-between mb-8">
                        <div class="d-flex align-items-center button-selected">
                            <button type="button" disabled onclick="actionModal(2)" class="btn btn-outline btn-outline-primary me-3">
                                <i class="fa fa-video"></i>
                                Interview
                            </button>
                            <button type="button" disabled onclick="actionModal(-1)" class="btn btn-outline btn-outline-danger">
                                <i class="fa fa-ban"></i>
                                Reject
                            </button>
                        </div>
                    ...
                    <div class="modal-body">
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center justify-content-around">
                                <!--begin::Col-->
                                <div class="fv-row int-n">
                                    <!--begin::Google link=-->
                                    <label for="role1" class="btn btn-outline active w-200px h-200px role d-flex flex-column btn-outline-primary border-active-primary border-secondary text-dark btn-active-light-primary text-hover-primary flex-center ">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{ route('job_report.export.excel') }}" method="post">
                    ...
                    <div class="modal-footer">
                        @csrf
                        <input type="hidden" name="type" value="_all">
                        <button type="button" class="btn text-primary" data-bs-dismiss="modal">Batal</button>
...
@section('custom_script')
    <script>
        ...
        function actionModal(n){
            ...
            var job_n = job.filter(onlyUnique)
            $("#modalInterview .int-m").show()
            if(job_n.length > 1){
                $("#modalInterview .int-m").hide()
            }
