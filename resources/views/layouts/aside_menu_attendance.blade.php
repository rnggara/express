...
<a href="{{ route('attendance.schedule.index') }}"
    ...
    {{-- <span class="d-inline">{{ __('Schedule') }}</span> --}}
    <span class="d-inline">{{ __('Jadwal') }}</span>
</a>
@endPermission
@hasPermission("attendance", "view", "registrations")
<a href="{{ route('attendance.registration.index') }}"
    class="btn btn-flex mb-5 btn-active-color-primary align-items-cenrer justify-content-center justify-content-md-between align-items-lg-center flex-md-content-between bg-opacity-10 px-0 ps-md-6 pe-md-5 h-30px h-md-35px">
    {{-- <span class="d-inline">{{ __('Registration') }}</span> --}}
    <span class="d-inline">{{ __('Registrasi') }}</span>
</a>
@endPermission
@hasPermission("attendance", "view", "correction")
<a href="{{ route('attendance.correction.index') }}"
    class="btn btn-flex mb-5 btn-active-color-primary align-items-cenrer justify-content-center justify-content-md-between align-items-lg-center flex-md-content-between bg-opacity-10 px-0 ps-md-6 pe-md-5 h-30px h-md-35px">
    {{-- <span class="d-inline">{{ __('Correction') }}</span> --}}
    <span class="d-inline">{{ __('Koreksi') }}</span>
</a>
@endPermission
@hasPermission("attendance", "view", "overtime")
<a href="{{ route("attendance.overtime.index") }}"
    class="btn btn-flex mb-5 btn-active-color-primary align-items-cenrer justify-content-center justify-content-md-between align-items-lg-center flex-md-content-between bg-opacity-10 px-0 ps-md-6 pe-md-5 h-30px h-md-35px">
    {{-- <span class="d-inline">{{ __('Overtime') }}</span> --}}
...
<a href="{{ route('attendance.leave.index') }}"
    class="btn btn-flex mb-5 btn-active-color-primary align-items-cenrer justify-content-center justify-content-md-between align-items-lg-center flex-md-content-between bg-opacity-10 px-0 ps-md-6 pe-md-5 h-30px h-md-35px">
    {{-- <span class="d-inline">{{ __('Leave') }}</span> --}}
...
<div>
    <button type="button"
        ...
        {{-- <span class="d-inline">{{ __('More') }}</span> --}}
