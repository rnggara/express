...
<body id="kt_body" class="header-fixed header-mobile-fixed page-loading-enabled">
    ...
    <script>
        ...
        function notifications_panel(){
            $("#notification-spinner").show()
            $("#notification-spinner div.spinner").show()
            $("#notifications-panel").html("")
            KTApp.block("#notifications-box", {})
            $.ajax({
                ...
                success : function(resp){
                    ...
                    $("#notifications-panel").html(resp.view)
                    $("#notifications-count").text(resp.count)
                }
            })
        }

        function _modal_pdf(file_name){
            $("#modal-pdf").html("")
            $.ajax({
                url : "{{ route("modal.pdf") }}/"+file_name,
                type : "get",
                success : function(resp){
                    $("#modal-pdf").html(resp)
                    $("#modalPdf").modal("show")
