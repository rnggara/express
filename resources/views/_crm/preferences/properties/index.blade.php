    ...
    <div class="card-body">
        <div class="d-flex flex-column">
            <div class="d-flex align-items-center justify-content-between">
                <span class="fw-bold fs-3">{{ ucwords($type ?? "Properties") }}</span>
        ...
        <div class="d-flex align-items-center mb-5">
            ...
            @if (empty($type))
                ...
                <span class="text-muted">{{ $detail->label }} <i class="fa fa-chevron-right mx-3 text-dark-75"></i></span>
                <span class="fw-semibold">Properties</span>
            @else
                <span class="fw-semibold">{{ ucwords($type) }}</span>
            @endif
        </div>
    </div>
                            ...
                            <div class="card-title">
                                <div class="d-flex flex-column">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="fs-3 fw-bold">Add Property</span>
                                    </div>
                                </div>
                            </div>
                        </div>
