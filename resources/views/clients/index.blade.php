    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            <div class="card-title">
                Client List
                @include('layouts._button_pdf')
            </div>
            @actionStart('client','create')
            <div class="card-toolbar">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addEmployee"><i class="fa fa-plus"></i>Add Client</button>
                </div>
                <!--end::Button-->
            </div>
            @actionEnd
                    ...
                    @foreach($clients as $key => $value)
                        <tr>
                                                ...
                                                <div class="row">
                                                    <div class="form col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="latitude" value="{{ $value->latitude }}"/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Longitude</label>
                                                            <input type="text" class="form-control" name="longitude"  value="{{ $value->longitude }}"/>
                                                        </div>
                                                    </div>
                                                    <div class="form col-md-6">
                                                        <div class="form-group">
                            ...
                            <td class="text-center">
                                <a href="#edit{{$value->id}}" data-bs-toggle="modal" class="btn btn-sm btn-primary btn-icon btn-icon-md" title="Edit"><i class="fa fa-edit"></i></a>
                                @actionStart('client','create')
