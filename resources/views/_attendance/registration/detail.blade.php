                    ...
                    <div class="col-3">
                        <div class="p-10 rounded bg-secondary-crm">
                            <div class="d-flex flex-column">
                                ...
                                <div class="bg-white rounded row p-5">
                                    <div class="d-flex align-items-center cursor-pointer" data-kt-drawer-show="true" data-kt-drawer-target="#kt_drawer_detail" onclick="show_detail({{ $reg->emp_id }})">
                                        <div class="symbol symbol-40px me-5">
                                            <div class="symbol-label bg-light-primary">
                                        ...
                                        <div class="d-flex flex-column">
                                            <span class="fw-bold fs-3">Data Karyawan</span>
                                            <span class="text-muted">Lihat lebih detil profil karyawan</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function loadAtt(act = null){
        ...
        $.ajax({
            url : "{{ route("attendance.registration.detail", $emp->id) }}?a=attendance",
            type : "get",
            data : {
                month : m,
                act : act
