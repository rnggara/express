                                ...
                                <td class="text-center">
                                    @if (empty($loan->approved_at))
                                        @actionStart('emp_loan', 'approvedir')
                                            <a href="{{ route('employee.loan.approval', $loan->id) }}" class="btn btn-primary btn-sm">
                                                Approval
                                            </a>
                                        @actionEnd
                                    @else
                                        Approved at {{ date("d F Y", strtotime($loan->approved_at)) }} {{ (!empty($loan->approved_by)) ? "by $loan->approved_by" : "" }}
                                    @endif
                                </td>
                                <td class="text-center">
