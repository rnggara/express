...
@section('view_content')
        ...
        <div class="card">
            <div class="card-header border-bottom-0 px-0">
                <div class="d-flex flex-column">
                    ...
                    <span>Detail dan aturan jenis kelamin</span>
                                    ...
                                    <td>
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <div class="d-flex flex-column align-items-center">
                                                                ...
                                                                <span class="text-center">make sure Jenis Kelamin not used to employee</span>
                                        ...
                                        <form action="{{ route("crm.pref.personel.marital_status.post") }}" method="post">
                                            @component('layouts._crm_modal', [
                                                ...
                                                @slot('modalTitle')
                                                    <div class="d-flex flex-column">
                                                        <span class="fs-1 fw-bold">Edit Jenis Kelamin</span>
                                                        <span class="fs-base fw-normal mt-2">Fill the form to set employee Jenis Kelamin</span>
                                                    </div>
                                                @endslot
                                                @slot('modalContent')
                                                    <div class="fv-row">
                                                    ...
                                                    <div class="fv-row">
                                                        ...
                                                        <input type="text" name="description" value="{{ $item->name }}" placeholder="Example: Male, Female, and others" class="form-control">
                                                        @error('description')
                                                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                                                {{ $message }}
                                                            </div>
    ...
    <form action="{{ route("crm.pref.personel.marital_status.post") }}" method="post">
        @component('layouts._crm_modal', [
            ...
            @slot('modalTitle')
                <div class="d-flex flex-column">
                    <span class="fs-1 fw-bold">Tambah Jenis Kelamin</span>
                    <span class="fs-base fw-normal mt-2">Fill the form to set employee Jenis Kelamin</span>
                </div>
            @endslot
            @slot('modalContent')
                ...
                <div class="fv-row">
                    <label class="col-form-label required">Description</label>
                    <input type="text" name="description" value="{{ old('description') }}" placeholder="Example: Male, Female, and others" class="form-control">
                    @error('description')
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            {{ $message }}
                        </div>
