...
@section('view_content')
        ...
        <div class="card">
            <div class="card-header border-bottom-0 px-0">
                <div class="d-flex flex-column">
                    ...
                    <span>Kelola status karyawan</span>
                </div>
            </div>
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route("crm.pref.personel.employee_status.post") }}" method="post">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <div class="d-flex flex-column align-items-center">
                                                                ...
                                                                <span class="text-center">make sure Educations not used to employee</span>
                                        ...
                                        <form action="{{ route("crm.pref.personel.employee_status.post") }}" method="post">
                                            @component('layouts._crm_modal', [
                                                ...
                                                @slot('modalTitle')
                                                    <div class="d-flex flex-column">
                                                        <span class="fs-1 fw-bold">Edit Status Karyawan</span>
                                                        <span class="fs-base fw-normal mt-2">Fill the form to set employee Status Karyawan</span>
                                                    </div>
                                                @endslot
                                                @slot('modalContent')
                                                    <div class="fv-row">
                                                        <label class="col-form-label required">Status Karyawan</label>
                                                        <input type="text" name="description" value="{{ $item->label }}" placeholder="Input Status Karyawan" class="form-control">
                                                        @error('description')
                                                    ...
                                                    <div class="fv-row mt-3">
                                                        <div class="form-check">
                                                            <label class="col-form-label form-check-label text-dark">
                                                                <input class="form-check-input" {{ $item->end_date == 1 ? "checked" : "" }} type="checkbox" name="end_date" value="1" />
                                                                Have end date?
                                                            </label>
                                                        </div>
                                                    </div>
    ...
    <form action="{{ route("crm.pref.personel.employee_status.post") }}" method="post">
        @component('layouts._crm_modal', [
            ...
            @slot('modalTitle')
                <div class="d-flex flex-column">
                    <span class="fs-1 fw-bold">Tambah Status Karyawan</span>
                    <span class="fs-base fw-normal mt-2">Fill the form to set employee Status Karyawan</span>
                </div>
            @endslot
            @slot('modalContent')
                <div class="fv-row">
                    <label class="col-form-label required">Status Karyawan</label>
                    <input type="text" name="description" placeholder="Input Status Karyawan" class="form-control">
                    @error('description')
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="fv-row mt-3">
                    <div class="form-check">
                        <label class="col-form-label form-check-label text-dark">
                            <input class="form-check-input" type="checkbox" name="end_date" value="1" />
                            Have end date?
                        </label>
                    </div>
                </div>
