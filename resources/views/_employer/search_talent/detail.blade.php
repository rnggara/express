...
<div class="container">
    <div class="d-flex flex-column">
        <a href="{{ $back ?? route("search_talent.index") }}" class="d-flex align-items-center mb-3">
                ...
                <div class="d-flex align-items-start flex-column flex-md-row justify-content-md-between">
                    <div class="d-flex align-items-start">
                        ...
                        <div class="d-flex flex-fill flex-column">
                            ...
                            <span class="mb-1">{{ $exp->position ?? "-" }} {{  ($exp->yoe ?? null) == null ? "" : "(".($exp->yoe ?? 0)." Tahun)" }}</span>
                            <span class="mb-1">{{ $exp->company ?? "-" }}</span>
                            <span class="mb-1">Gaji yang diharapkan Rp. {{ number_format($profile->salary_expect ?? ($exp->salary ?? 0), 2, ",", ".") }}</span>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        ...
                        <button type="button" class="btn btn-sm btn-outline text-primary" data-toggle="bookmark" data-id="{{$applicant->id}}">
                            <i class="fa-bookmark text-primary {{ !empty($bookmarked) && $bookmarked->bookmarked == 1 ? "fa" : "far" }}"></i>
                            <span>{{ !empty($bookmarked) && $bookmarked->bookmarked == 1 ? "Bookmarked" : "Bookmark" }}</span>
                        </button>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <label class="col-form-label">{{ $medsos->facebook ?? "" }}</label>
                                        </div>
                                    </div>
                                </div>
                                @endif
